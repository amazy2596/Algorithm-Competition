...
void solve()
{
    ...
    auto best_fraction = a[1];
    for (int i = 2; i <= n; i++)
    {
        auto current_fraction = a[i];
        BigDecimal lhs = abs(pi * current_fraction.second - current_fraction.first) * best_fraction.second;
        BigDecimal rhs = abs(pi * best_fraction.second - best_fraction.first) * current_fraction.second;
        ...
        {
            if (current_fraction.first < best_fraction.first)
            {
                best_fraction = current_fraction;
            }
        }
    ...
    cout << best_fraction.first << ' ' << best_fraction.second << "\n";
}
