// Problem: 【模板】线段树 1.5
// URL: https://www.luogu.com.cn/problem/P13825
// Author: amazy
// Date: 2025-09-19 18:24:44
...
void solve()
{
    int n, m;
    cin >> n >> m;
    SegmentTree<info, tagAdd> segtree(n + 1);
    while (m--)
    {
        int op;
        cin >> op;
        ...
        else 
        {
            int l, r;
            cin >> l >> r;
            i128 ans = segtree.query(l, r).sum;
            ans += (i128)(l + r) * (r - l + 1) / 2;
            cout << ans << "\n";
        }
    }
}
