...
void solve()
{
    ...
    BigInt ans1("0"), ans2("0"), ans3("0"), ans4("0");
    ...
    if  (x < d || x == d)
    {
        if  (rem < y || rem == y)
        {
            ans1 = ans1 + min(a, rem * b);
        }
        else
        {
            ans1 = ans1 + min(a, y * b + (rem - y) * c);
        }
    }
    else 
    {
    ...
    ans2 = ans2 + (d / (x + y)) * (a + y * b);
    rem = d % (x + y);
    if  (x + y < d || d == x + y)
    {
        if  (rem < x || rem == x)
        {
            ans2 = ans2 + min(a, rem * c);
        }
        else 
        {
            ans2 = ans2 + min(a + (rem - x) * b, rem * c);
        }
    }
    else 
    {
    ...
    {
        ans3 = ans3 + a + y * b + (d - x - y) * c;
    }

    ans4 = ans4 + (d / (x + y)) * (a + y * b);
    rem = d % (x + y);
    if  (x + y < d || d == x + y)
    {
        if  (rem < x || rem == x)
